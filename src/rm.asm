...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 40a:	f7 f3                	div    %ebx
 40c:	0f b6 92 8c 0c 00 00 	movzbl 0xc8c(%edx),%edx
 ...
 555:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 5af:	ff 24 85 dc 0b 00 00 	jmp    *0xbdc(,%eax,4)
 ...
 663:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 667:	b8 d5 0b 00 00       	mov    $0xbd5,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 880:	ff 24 85 34 0c 00 00 	jmp    *0xc34(,%eax,4)
 ...
 9fb:	e9 b4 fe ff ff       	jmp    8b4 <fprintf+0x84>
          s = "(null)";
 a00:	bf d5 0b 00 00       	mov    $0xbd5,%edi
...
free(void *ap)
{
 ...
 a21:	a1 b4 0f 00 00       	mov    0xfb4,%eax
{
 ...
 a69:	5b                   	pop    %ebx
  freep = p;
 a6a:	89 15 b4 0f 00 00    	mov    %edx,0xfb4
}
 a70:	5e                   	pop    %esi
 a71:	5f                   	pop    %edi
 a72:	5d                   	pop    %ebp
 ...
 aa7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aaa:	89 15 b4 0f 00 00    	mov    %edx,0xfb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ac9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 acc:	8b 15 b4 0f 00 00    	mov    0xfb4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b0b:	39 05 b4 0f 00 00    	cmp    %eax,0xfb4
 ...
 b2e:	e8 ed fe ff ff       	call   a20 <free>
  return freep;
 b33:	8b 15 b4 0f 00 00    	mov    0xfb4,%edx
 ...
 b5c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b5f:	89 15 b4 0f 00 00    	mov    %edx,0xfb4
}
 ...
 b6f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b70:	c7 05 b4 0f 00 00 b8 	movl   $0xfb8,0xfb4
 b77:	0f 00 00 
    base.s.size = 0;
 b7a:	b8 b8 0f 00 00       	mov    $0xfb8,%eax
    base.s.ptr = freep = prevp = &base;
 b7f:	c7 05 b8 0f 00 00 b8 	movl   $0xfb8,0xfb8
 b86:	0f 00 00 
    base.s.size = 0;
 b89:	c7 05 bc 0f 00 00 00 	movl   $0x0,0xfbc
 b90:	00 00 00 
    if(p->s.size >= nunits){
