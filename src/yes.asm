...
main(int argc, char **argv)
{
  ...
  23:	68 8c 0b 00 00       	push   $0xb8c
  28:	68 88 0b 00 00       	push   $0xb88
  2d:	e8 fe 04 00 00       	call   530 <printf>
  32:	83 c4 10             	add    $0x10,%esp
  35:	83 fe 01             	cmp    $0x1,%esi
  38:	7e e6                	jle    20 <main+0x20>
  3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  40:	83 ec 08             	sub    $0x8,%esp
  43:	ff 73 04             	push   0x4(%ebx)
  46:	68 88 0b 00 00       	push   $0xb88
  4b:	e8 e0 04 00 00       	call   530 <printf>
  50:	83 c4 10             	add    $0x10,%esp
  53:	eb eb                	jmp    40 <main+0x40>
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 3ea:	f7 f3                	div    %ebx
 3ec:	0f b6 92 48 0c 00 00 	movzbl 0xc48(%edx),%edx
 ...
 535:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 58f:	ff 24 85 98 0b 00 00 	jmp    *0xb98(,%eax,4)
 ...
 643:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 647:	b8 8e 0b 00 00       	mov    $0xb8e,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 860:	ff 24 85 f0 0b 00 00 	jmp    *0xbf0(,%eax,4)
 ...
 9db:	e9 b4 fe ff ff       	jmp    894 <fprintf+0x84>
          s = "(null)";
 9e0:	bf 8e 0b 00 00       	mov    $0xb8e,%edi
...
free(void *ap)
{
 ...
 a01:	a1 68 0f 00 00       	mov    0xf68,%eax
{
 ...
 a49:	5b                   	pop    %ebx
  freep = p;
 a4a:	89 15 68 0f 00 00    	mov    %edx,0xf68
}
 a50:	5e                   	pop    %esi
 a51:	5f                   	pop    %edi
 a52:	5d                   	pop    %ebp
 ...
 a87:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 a8a:	89 15 68 0f 00 00    	mov    %edx,0xf68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 aa9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 aac:	8b 15 68 0f 00 00    	mov    0xf68,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 aeb:	39 05 68 0f 00 00    	cmp    %eax,0xf68
 ...
 b0e:	e8 ed fe ff ff       	call   a00 <free>
  return freep;
 b13:	8b 15 68 0f 00 00    	mov    0xf68,%edx
 ...
 b3c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b3f:	89 15 68 0f 00 00    	mov    %edx,0xf68
}
 ...
 b4f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b50:	c7 05 68 0f 00 00 6c 	movl   $0xf6c,0xf68
 b57:	0f 00 00 
    base.s.size = 0;
 b5a:	b8 6c 0f 00 00       	mov    $0xf6c,%eax
    base.s.ptr = freep = prevp = &base;
 b5f:	c7 05 6c 0f 00 00 6c 	movl   $0xf6c,0xf6c
 b66:	0f 00 00 
    base.s.size = 0;
 b69:	c7 05 70 0f 00 00 00 	movl   $0x0,0xf70
 b70:	00 00 00 
    if(p->s.size >= nunits){
