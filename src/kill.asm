...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 40a:	f7 f3                	div    %ebx
 40c:	0f b6 92 74 0c 00 00 	movzbl 0xc74(%edx),%edx
 ...
 555:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 5af:	ff 24 85 c4 0b 00 00 	jmp    *0xbc4(,%eax,4)
 ...
 663:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 667:	b8 bc 0b 00 00       	mov    $0xbbc,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 880:	ff 24 85 1c 0c 00 00 	jmp    *0xc1c(,%eax,4)
 ...
 9fb:	e9 b4 fe ff ff       	jmp    8b4 <fprintf+0x84>
          s = "(null)";
 a00:	bf bc 0b 00 00       	mov    $0xbbc,%edi
...
free(void *ap)
{
 ...
 a21:	a1 9c 0f 00 00       	mov    0xf9c,%eax
{
 ...
 a69:	5b                   	pop    %ebx
  freep = p;
 a6a:	89 15 9c 0f 00 00    	mov    %edx,0xf9c
}
 a70:	5e                   	pop    %esi
 a71:	5f                   	pop    %edi
 a72:	5d                   	pop    %ebp
 ...
 aa7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aaa:	89 15 9c 0f 00 00    	mov    %edx,0xf9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ac9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 acc:	8b 15 9c 0f 00 00    	mov    0xf9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b0b:	39 05 9c 0f 00 00    	cmp    %eax,0xf9c
 ...
 b2e:	e8 ed fe ff ff       	call   a20 <free>
  return freep;
 b33:	8b 15 9c 0f 00 00    	mov    0xf9c,%edx
 ...
 b5c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b5f:	89 15 9c 0f 00 00    	mov    %edx,0xf9c
}
 ...
 b6f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b70:	c7 05 9c 0f 00 00 a0 	movl   $0xfa0,0xf9c
 b77:	0f 00 00 
    base.s.size = 0;
 b7a:	b8 a0 0f 00 00       	mov    $0xfa0,%eax
    base.s.ptr = freep = prevp = &base;
 b7f:	c7 05 a0 0f 00 00 a0 	movl   $0xfa0,0xfa0
 b86:	0f 00 00 
    base.s.size = 0;
 b89:	c7 05 a4 0f 00 00 00 	movl   $0x0,0xfa4
 b90:	00 00 00 
    if(p->s.size >= nunits){
