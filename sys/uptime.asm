...
main()
{
  ...
  int ticks = uptime();
  13:	e8 73 03 00 00       	call   38b <uptime>
  ...
  22:	f7 ea                	imul   %edx
  int minutes = total_seconds / 60;
  24:	b8 89 88 88 88       	mov    $0x88888889,%eax
  int total_seconds = ticks / 100;  // Convert ticks to seconds
  29:	c1 fb 1f             	sar    $0x1f,%ebx
  2c:	c1 fa 05             	sar    $0x5,%edx
  ...
  int minutes = total_seconds / 60;
  39:	c1 f8 1f             	sar    $0x1f,%eax
  3c:	8d 1c 0a             	lea    (%edx,%ecx,1),%ebx
  3f:	c1 fb 05             	sar    $0x5,%ebx
  42:	29 c3                	sub    %eax,%ebx
  int seconds = total_seconds % 60;
  44:	6b c3 3c             	imul   $0x3c,%ebx,%eax
  47:	29 c6                	sub    %eax,%esi
  if (gettime(&r) == 0) {
  49:	8d 45 d0             	lea    -0x30(%ebp),%eax
  4c:	50                   	push   %eax
  4d:	e8 51 03 00 00       	call   3a3 <gettime>
  ...
  5c:	56                   	push   %esi
  5d:	53                   	push   %ebx
  5e:	68 d3 0b 00 00       	push   $0xbd3
  63:	e8 08 05 00 00       	call   570 <printf>
  exit();
  68:	e8 86 02 00 00       	call   2f3 <exit>
    printf(" %d:%02d  ",
  6d:	ff 75 d0             	push   -0x30(%ebp)
  70:	ff 75 d4             	push   -0x2c(%ebp)
  73:	ff 75 d8             	push   -0x28(%ebp)
  76:	68 c8 0b 00 00       	push   $0xbc8
  7b:	e8 f0 04 00 00       	call   570 <printf>
  80:	83 c4 10             	add    $0x10,%esp
  83:	eb d4                	jmp    59 <main+0x59>
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 42a:	f7 f3                	div    %ebx
 42c:	0f b6 92 a4 0c 00 00 	movzbl 0xca4(%edx),%edx
 ...
 575:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 5cf:	ff 24 85 f4 0b 00 00 	jmp    *0xbf4(,%eax,4)
 ...
 683:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 687:	b8 eb 0b 00 00       	mov    $0xbeb,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 8a0:	ff 24 85 4c 0c 00 00 	jmp    *0xc4c(,%eax,4)
 ...
 a1b:	e9 b4 fe ff ff       	jmp    8d4 <fprintf+0x84>
          s = "(null)";
 a20:	bf eb 0b 00 00       	mov    $0xbeb,%edi
...
free(void *ap)
{
 ...
 a41:	a1 c4 0f 00 00       	mov    0xfc4,%eax
{
 ...
 a89:	5b                   	pop    %ebx
  freep = p;
 a8a:	89 15 c4 0f 00 00    	mov    %edx,0xfc4
}
 a90:	5e                   	pop    %esi
 a91:	5f                   	pop    %edi
 a92:	5d                   	pop    %ebp
 ...
 ac7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aca:	89 15 c4 0f 00 00    	mov    %edx,0xfc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ae9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 aec:	8b 15 c4 0f 00 00    	mov    0xfc4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b2b:	39 05 c4 0f 00 00    	cmp    %eax,0xfc4
 ...
 b4e:	e8 ed fe ff ff       	call   a40 <free>
  return freep;
 b53:	8b 15 c4 0f 00 00    	mov    0xfc4,%edx
 ...
 b7c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b7f:	89 15 c4 0f 00 00    	mov    %edx,0xfc4
}
 ...
 b8f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b90:	c7 05 c4 0f 00 00 c8 	movl   $0xfc8,0xfc4
 b97:	0f 00 00 
    base.s.size = 0;
 b9a:	b8 c8 0f 00 00       	mov    $0xfc8,%eax
    base.s.ptr = freep = prevp = &base;
 b9f:	c7 05 c8 0f 00 00 c8 	movl   $0xfc8,0xfc8
 ba6:	0f 00 00 
    base.s.size = 0;
 ba9:	c7 05 cc 0f 00 00 00 	movl   $0x0,0xfcc
 bb0:	00 00 00 
    if(p->s.size >= nunits){
