...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 40a:	f7 f3                	div    %ebx
 40c:	0f b6 92 68 0c 00 00 	movzbl 0xc68(%edx),%edx
 ...
 555:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 5af:	ff 24 85 b8 0b 00 00 	jmp    *0xbb8(,%eax,4)
 ...
 663:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 667:	b8 b1 0b 00 00       	mov    $0xbb1,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 880:	ff 24 85 10 0c 00 00 	jmp    *0xc10(,%eax,4)
 ...
 9fb:	e9 b4 fe ff ff       	jmp    8b4 <fprintf+0x84>
          s = "(null)";
 a00:	bf b1 0b 00 00       	mov    $0xbb1,%edi
...
free(void *ap)
{
 ...
 a21:	a1 8c 0f 00 00       	mov    0xf8c,%eax
{
 ...
 a69:	5b                   	pop    %ebx
  freep = p;
 a6a:	89 15 8c 0f 00 00    	mov    %edx,0xf8c
}
 a70:	5e                   	pop    %esi
 a71:	5f                   	pop    %edi
 a72:	5d                   	pop    %ebp
 ...
 aa7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 aaa:	89 15 8c 0f 00 00    	mov    %edx,0xf8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 ac9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 acc:	8b 15 8c 0f 00 00    	mov    0xf8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b0b:	39 05 8c 0f 00 00    	cmp    %eax,0xf8c
 ...
 b2e:	e8 ed fe ff ff       	call   a20 <free>
  return freep;
 b33:	8b 15 8c 0f 00 00    	mov    0xf8c,%edx
 ...
 b5c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b5f:	89 15 8c 0f 00 00    	mov    %edx,0xf8c
}
 ...
 b6f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b70:	c7 05 8c 0f 00 00 90 	movl   $0xf90,0xf8c
 b77:	0f 00 00 
    base.s.size = 0;
 b7a:	b8 90 0f 00 00       	mov    $0xf90,%eax
    base.s.ptr = freep = prevp = &base;
 b7f:	c7 05 90 0f 00 00 90 	movl   $0xf90,0xf90
 b86:	0f 00 00 
    base.s.size = 0;
 b89:	c7 05 94 0f 00 00 00 	movl   $0x0,0xf94
 b90:	00 00 00 
    if(p->s.size >= nunits){
