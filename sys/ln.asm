   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
  15:	74 12                	je     29 <main+0x29>
    printf("usage: ln old new\n");
  17:	83 ec 0c             	sub    $0xc,%esp
  1a:	68 88 0b 00 00       	push   $0xb88
  1f:	e8 0c 05 00 00       	call   530 <printf>
    exit();
  ...
  31:	e8 dd 02 00 00       	call   313 <link>
  36:	83 c4 10             	add    $0x10,%esp
  39:	85 c0                	test   %eax,%eax
  3b:	78 05                	js     42 <main+0x42>
  ...
  49:	68 9b 0b 00 00       	push   $0xb9b
  4e:	e8 dd 04 00 00       	call   530 <printf>
  53:	83 c4 10             	add    $0x10,%esp
  56:	eb e5                	jmp    3d <main+0x3d>
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn, int width, char pad_char)
 ...
 3ea:	f7 f3                	div    %ebx
 3ec:	0f b6 92 68 0c 00 00 	movzbl 0xc68(%edx),%edx
 ...
 535:	8d 75 0c             	lea    0xc(%ebp),%esi
{
 ...
 58f:	ff 24 85 b8 0b 00 00 	jmp    *0xbb8(,%eax,4)
 ...
 643:	c6 45 d0 28          	movb   $0x28,-0x30(%ebp)
          s = "(null)";
 647:	b8 af 0b 00 00       	mov    $0xbaf,%eax
        int len = 0;
...
fprintf(int fd, char *fmt, ...)
{
 ...
 860:	ff 24 85 10 0c 00 00 	jmp    *0xc10(,%eax,4)
 ...
 9db:	e9 b4 fe ff ff       	jmp    894 <fprintf+0x84>
          s = "(null)";
 9e0:	bf af 0b 00 00       	mov    $0xbaf,%edi
...
free(void *ap)
{
 ...
 a01:	a1 84 0f 00 00       	mov    0xf84,%eax
{
 ...
 a49:	5b                   	pop    %ebx
  freep = p;
 a4a:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 a50:	5e                   	pop    %esi
 a51:	5f                   	pop    %edi
 a52:	5d                   	pop    %ebp
 ...
 a87:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 a8a:	89 15 84 0f 00 00    	mov    %edx,0xf84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 aa9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 aac:	8b 15 84 0f 00 00    	mov    0xf84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 aeb:	39 05 84 0f 00 00    	cmp    %eax,0xf84
 ...
 b0e:	e8 ed fe ff ff       	call   a00 <free>
  return freep;
 b13:	8b 15 84 0f 00 00    	mov    0xf84,%edx
 ...
 b3c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b3f:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 ...
 b4f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 b50:	c7 05 84 0f 00 00 88 	movl   $0xf88,0xf84
 b57:	0f 00 00 
    base.s.size = 0;
 b5a:	b8 88 0f 00 00       	mov    $0xf88,%eax
    base.s.ptr = freep = prevp = &base;
 b5f:	c7 05 88 0f 00 00 88 	movl   $0xf88,0xf88
 b66:	0f 00 00 
    base.s.size = 0;
 b69:	c7 05 8c 0f 00 00 00 	movl   $0x0,0xf8c
 b70:	00 00 00 
    if(p->s.size >= nunits){
